...
def set_zero_origin(input_map):
    """
    * Filter volume based on local resolution

    #. Input:   input volume, local_resolution_volume, [mask file] 
    #. Output:  
    #. Usage:   filter_volume = local_resolution_filter(input_map, local_resolution_map, filtered_map, mask_file)
    """
    map = EMData()
